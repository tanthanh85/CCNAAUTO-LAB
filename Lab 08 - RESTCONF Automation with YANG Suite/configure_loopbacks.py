...
for item in data["loopbacks"]:
    ...
    if args.apply:
        ...
        require(response, {200, 201, 204}); print(" ", response.status_code)
if not args.apply: print("Dry run only. Use --apply after validating the URI and payload in YANG Suite.")
